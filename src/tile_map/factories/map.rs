...
use crate::tile_map::resources::sprites::SpriteStore;
...
pub fn initialise_map(world: &mut World, sprite_store: &SpriteStore) {
    ...
    for y in 0..MAP_HEIGHT {
        for x in 0..MAP_WIDTH {
            initialise_tile(world, x, y, sprite_store.get_ground());
        }
    }
}

fn initialise_tile(world: &mut World, x: usize, y: usize, sprite: SpriteRender) {
